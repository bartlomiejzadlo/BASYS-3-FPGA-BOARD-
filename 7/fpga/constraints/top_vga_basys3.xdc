...
## Switches
set_property PACKAGE_PIN V17 [get_ports RFData_en]
	set_property IOSTANDARD LVCMOS33 [get_ports RFData_en]
set_property PACKAGE_PIN V16 [get_ports Instr_en]
	set_property IOSTANDARD LVCMOS33 [get_ports Instr_en]
set_property PACKAGE_PIN W16 [get_ports PC_en]
	set_property IOSTANDARD LVCMOS33 [get_ports PC_en]
set_property PACKAGE_PIN W17 [get_ports PCsw]
	set_property IOSTANDARD LVCMOS33 [get_ports PCsw]
...
#set_property PACKAGE_PIN T18 [get_ports PCen]
	#set_property IOSTANDARD LVCMOS33 [get_ports PCen]
set_property PACKAGE_PIN W19 [get_ports extCtl_btn]
	set_property IOSTANDARD LVCMOS33 [get_ports extCtl_btn]
set_property PACKAGE_PIN T17 [get_ports PCenable_btn]
	set_property IOSTANDARD LVCMOS33 [get_ports PCenable_btn]
